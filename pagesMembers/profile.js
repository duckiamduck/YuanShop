...
const _sfc_main = /* @__PURE__ */ common_vendor.defineComponent({
  ...
  setup(__props) {
    ...
    const onSubmit = async () => {
      ...
      const res = await services_profile.PutMeberProfile({
        nickname,
        gender,
        birthday,
    ...
    return (_ctx, _cache) => {
      ...
      return common_vendor.e({
        ...
        n: common_vendor.unref(utils_index.formatDate)(/* @__PURE__ */ new Date()),
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__file", "G:/gitCode/heima-shop/src/pagesMembers/profile.vue"]]);
