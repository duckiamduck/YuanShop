...
const _sfc_main = /* @__PURE__ */ common_vendor.defineComponent({
  ...
  setup(__props) {
    ...
    const GetBannerData = async () => {
      const rs = await services_home.getHomeBannerAPI();
      bannerList.value = rs.result;
    };
    const categoryList = common_vendor.ref([]);
    const activeIndex = common_vendor.ref(0);
    const getCategoryData = async () => {
      const rs = await services_category.getCategoryAPI();
      categoryList.value = rs.result;
    };
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__file", "G:/gitCode/heima-shop/src/pages/category/category.vue"]]);
