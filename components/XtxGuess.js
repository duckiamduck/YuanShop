...
const _sfc_main = /* @__PURE__ */ common_vendor.defineComponent({
  ...
  setup(__props, { expose }) {
    ...
    return (_ctx, _cache) => {
      return {
        a: common_vendor.f(guessList.value, (item, index, i0) => {
          return {
            a: item.picture,
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__file", "G:/gitCode/heima-shop/src/components/XtxGuess.vue"]]);
